        ...
        <div class="container">
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <ul class="nav-menu lg-device" style="margin-left: 550px;">
                    ...
                    <li class="menu-item-has-children">
                    <a href="/news" style="color:#fff;"><i class="far fa-newspaper" style="font-size: 14px;"></i> News</a>
                    </li>
                ...
                <div class="nav-menus-wrapper align-to-right"   style="transition-property: none;color:#fff;">
