            ...
            'en_US' => [
                [
                    ...
                    'content'  =>
                        Html::tag(
                            'div',
                            '[hero-banner title="Find accessible homes to Commercial" bg="banners/banner-1.png"][/hero-banner]'
                        ) .
                ...
                [
                    ...
                    'content'  =>
                        Html::tag(
                            'div',
                            '[hero-banner title="Find accessible homes to Commercial" bg="banners/banner-svg.jpg" style="2"]Find Your Perfect Place.[/hero-banner]'
                        ) .
                ...
                [
                    ...
                    'content'  =>
                        Html::tag(
                            'div',
                            '[hero-banner title="Find accessible homes to Commercial" bg="banners/banner-1.png"]'
                        ) .
                        Html::tag(
                            'div',
                            '[featured-properties title="Explore Good Places" limit="6" style="1"]At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores[/featured-properties]'
                ...
                [
                    ...
                    'content'  =>
                        Html::tag(
                            'div',
                            '[hero-banner title="Find accessible homes to Commercial" bg="banners/new-banner.jpg" style="2"]Find Your Perfect Place.[/hero-banner]'
                        ) .
                        Html::tag('div', '[static-block alias="achievement"][/static-block]') .
                        Html::tag(
                            'div',
