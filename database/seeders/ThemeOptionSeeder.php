    ...
    public function run()
    {
        ...
        $data = [
            'en_US' => [
                ...
                [
                    'key'   => 'site_title',
                    'value' => 'Gruham24 - Real Estate In Pune',
                ],
                [
                    'key'   => 'seo_description',
            ...
            'vi' => [
                ...
                [
                    'key'   => 'seo_description',
                    'value' => 'Gruham24 is a premium real estate related websites build on Laravel. With an advanced admin dashboard that will help you create a local or global real-estate directory site.',
                ],
                [
                    'key'   => 'seo_og_image',
                    'value' => 'general/screenshot.png',
